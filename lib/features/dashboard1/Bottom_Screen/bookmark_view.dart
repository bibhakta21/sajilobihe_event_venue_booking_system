        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text("Capacity: ${venue.capacity}", style: const TextStyle(fontWeight: FontWeight.w500)),
                Text("Price: \$${venue.price.toStringAsFixed(2)} / Plate", style: const TextStyle(fontWeight: FontWeight.w500, color: Colors.redAccent)),
              ],
            ),
            const SizedBox(height: 10),
